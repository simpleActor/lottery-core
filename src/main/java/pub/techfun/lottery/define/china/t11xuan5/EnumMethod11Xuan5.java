package pub.techfun.lottery.define.china.t11xuan5;
...
@Getter
@AllArgsConstructor
public enum EnumMethod11Xuan5 implements LotteryMethod {
    ...
    static {
        for (EnumMethod11Xuan5 item : EnumMethod11Xuan5.values()) {
