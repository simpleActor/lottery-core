...
public class Combination implements Serializable {
     ...
     * @param datas 用于组合的数据
     */
    public Combination(Integer[] datas) {
        this.datas = datas;
    }
    ...
    public List<Integer[]> select(int m) {
        ...
        select(0, new Integer[m], 0, result);
        return result;
    }
     ...
     * @param result      结果集
     */
    private void select(int dataIndex, Integer[] resultList, int resultIndex, List<Integer[]> result) {
