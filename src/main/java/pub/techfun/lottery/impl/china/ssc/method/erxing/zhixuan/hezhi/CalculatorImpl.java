package pub.techfun.lottery.impl.china.ssc.method.erxing.zhixuan.hezhi;
...
public class CalculatorImpl extends SSCAbstractCalculator<BetImpl> {
    ...
    public BetRegion cover(String bet) {
        ...
        List<BetSection> sectionList = CoverUtil.getFullCoverByNumLists(this.indexes, lists);
    ...
    public double coverRate(String bet) {
        //乘以1000转换为5星注数
        return newBetWrapper(bet).getCount() * 1000 / SSCConfig.ALL_FACTOR;
    }
