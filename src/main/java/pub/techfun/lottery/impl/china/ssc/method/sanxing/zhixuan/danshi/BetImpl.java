package pub.techfun.lottery.impl.china.ssc.method.sanxing.zhixuan.danshi;
...
class BetImpl extends SSCAbstractBetWrapper {
    ...
    /** region 约束 */
    public static final RegionParam REGION_CONSTRAINT = new RegionParam(1, 1000, false);
    /** section 约束 */
    public static final SectionParam SECTION_CONSTRAINT = new SectionParam(0, 9, 3, 3, true, true);
