...
class BetImpl extends SSCAbstractBetWrapper {
    ...
    /** region 约束 */
    public static final RegionParam REGION_CONSTRAINT = new RegionParam(1, 50, false);
    /** section 约束 */
    public static final SectionParam SECTION_CONSTRAINT = new SectionParam(0, 9, 2, 2, true, false);
