package pub.techfun.lottery.impl.china.ssc.method.daxiaodanshuang.geshu.daxiao.sixing;
...
class BetImpl extends SSCAbstractBetWrapper {
     ...
     * section 约束
     */
    public static final SectionParam SECTION_CONSTRAINT = new SectionParam(0, 1, 5, 5, true, true);
