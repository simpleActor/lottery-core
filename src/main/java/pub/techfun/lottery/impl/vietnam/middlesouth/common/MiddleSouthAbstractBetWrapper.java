...
public abstract class MiddleSouthAbstractBetWrapper implements BetWrapper {
    ...
    public MiddleSouthAbstractBetWrapper(String bet) {
        init(bet);
    }

    public MiddleSouthAbstractBetWrapper(String bet, BetFormatter formatter) {
